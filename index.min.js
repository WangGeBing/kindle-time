...
function render() {
  ...
  var dateText = ""
    .concat(formatDate(date, "yyyy.M.d"), " ")
    .concat(
      urlQuery.l == "en"
  ...
  var timeText = ""
    ...
    .concat(date.getSeconds()); // 包含秒数
  var cnDateText = ""
    .concat(lunar.IMonthCn)
    .concat(lunar.IDayCn, " ")
    .concat(lunar.Animal, "\u5E74");
...
domApp.style.cssText = "-webkit-transform: rotate(".concat(
  config.rotate || 0,
